...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jhou3sg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jhou3sg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Almo7aya/container-jhou3sg.git
cd container-jhou3sg
```
...
```
docker attach container-jhou3sg
```
